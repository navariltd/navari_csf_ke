...
def get_columns():
	columns = [
		...
		{"label": _("Surname"), "fieldname": "last_name", "fieldtype": "Data", "width": 140},
		{"label": _("Other Names"), "fieldname": "other_name", "fieldtype": "Data", "width": 200},
		{"label": _("National ID"), "fieldname": "national_id", "fieldtype": "Data", "width": 140},
		{"label": _("KRA No"), "fieldname": "tax_id", "fieldtype": "Data", "width": 140},
		{"label": _("NSSF No"), "fieldname": "nssf_no", "fieldtype": "Data", "width": 140},
		{"label": _("Gross Pay"), "fieldname": "gross_pay", "fieldtype": "Currency", "width": 200},
		{"label": _("NSSF Amount"), "fieldname": "amount", "fieldtype": "Currency", "width": 140},
	]
